    ...
    <div >
        ...
        <div className="grid-container">
          ...
          <div className="grid-item">
            ...
            <div id="projectlinks">
                <a href="https://github.com/aaronbe7/Lyrico" target="_blank">Code</a>
                <a href="https://lyricoapp.herokuapp.com/" target="_blank">Website</a>
             </div>
          </div>
          ...
          <div className="title">Goal Tracker:</div><br/><br/>
            ...
            <div id="projectlinks">
                <a href="https://github.com/aaronbe7/goal_tracker" target="_blank">Code</a>
                <a href="http://goal-tracker-django.herokuapp.com/" target="_blank">Website</a>
             </div>
          </div>
          ...
          <div className="grid-item">
            ...
            <div className="description">
              ...
              <div id="projectlinks">
                <a href="https://github.com/aaronbe7/music-rank" target="_blank">Code</a>
                <a href="https://music-rank.herokuapp.com/" target="_blank">Website</a>
             </div>
          </div>
